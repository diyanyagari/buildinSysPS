...
@Component({
	selector: 'app-widget-persentasi-pengajuan',
	templateUrl: './persentasi-pengajuan.component.html'
})

export class WidgetPersentasiPengajuanComponent implements OnInit, OnDestroy {
