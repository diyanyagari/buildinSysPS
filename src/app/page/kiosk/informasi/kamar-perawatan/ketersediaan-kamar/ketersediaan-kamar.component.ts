...
@Component({
  selector: 'app-ketersediaan-kamar',
  templateUrl: './ketersediaan-kamar.component.html',
  styleUrls: ['./ketersediaan-kamar.component.scss', '../../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class KetersediaanKamarComponent implements OnInit, OnDestroy {
