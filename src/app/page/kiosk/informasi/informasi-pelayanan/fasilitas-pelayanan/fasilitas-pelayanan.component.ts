...
@Component({
  selector: 'app-fasilitas-pelayanan',
  templateUrl: './fasilitas-pelayanan.component.html',
  styleUrls: ['./fasilitas-pelayanan.component.scss', '../../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class FasilitasPelayananComponent implements OnInit, OnDestroy {
  data: any[];
  constructor(
  ...
  getData() {
    this.httpService.get(`${Configuration.get().klinik1Java}/FasilitasLayananController/getFasilitasLayanan`).subscribe(res => {
