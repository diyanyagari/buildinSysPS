...
@Component({
  selector: 'app-promosi-dan-kegiatan',
  templateUrl: './promosi-dan-kegiatan.component.html',
  styleUrls: ['./promosi-dan-kegiatan.component.scss', '../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class PromosiDanKegiatanComponent implements OnInit {
