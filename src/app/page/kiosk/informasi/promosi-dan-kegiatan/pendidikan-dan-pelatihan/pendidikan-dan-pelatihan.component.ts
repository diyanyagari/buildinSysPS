...
import { HttpClient, NotificationService, Authentication, InfoService, Configuration } from '../../../../../global';

@Component({
  selector: 'app-pendidikan-dan-pelatihan',
  templateUrl: './pendidikan-dan-pelatihan.component.html',
  styleUrls: ['./pendidikan-dan-pelatihan.component.scss', '../../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class PendidikanDanPelatihanComponent implements OnInit, OnDestroy {
