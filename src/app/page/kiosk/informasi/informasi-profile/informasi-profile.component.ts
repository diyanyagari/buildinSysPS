...
@Component({
	selector: "app-informasi-profile",
	templateUrl: "./informasi-profile.component.html",
	styleUrls: [
		"./informasi-profile.component.scss",
		"../../kiosk-global.scss"
	],
	providers: [ConfirmationService]
})
export class InformasiProfileComponent implements OnInit, OnDestroy {
	constructor(
