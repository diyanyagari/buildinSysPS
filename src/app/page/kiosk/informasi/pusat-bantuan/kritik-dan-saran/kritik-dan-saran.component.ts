...
@Component({
  selector: 'app-kritik-dan-saran',
  templateUrl: './kritik-dan-saran.component.html',
  styleUrls: ['./kritik-dan-saran.component.scss', '../../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class KritikDanSaranComponent implements OnInit, OnDestroy {
