...
@Component({
  selector: 'app-survey-kepuasan',
  templateUrl: './survey-kepuasan.component.html',
  styleUrls: ['./survey-kepuasan.component.scss', '../../../kiosk-global.scss'],
  providers: [ConfirmationService]
})
export class SurveyKepuasanComponent implements OnInit, OnDestroy {
