...
// import { RangeMasaKerjaThrComponent } from './range-masakerja-thr.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-thr',
  templateUrl: './range-masakerja-thr.component.html',
  styleUrls: ['./range-masakerja-thr.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaThrComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaTHR').subscribe(res => {
