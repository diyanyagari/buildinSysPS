...
import { PegawaiSkGajiBA } from './pegawai-sk-gaji-ba.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { AlertService, InfoService, Configuration } from '../../../global';

@Component({
  selector: 'app-pegawai-sk-gaji-ba',
  templateUrl: './pegawai-sk-gaji-ba.component.html',
  styleUrls: ['./pegawai-sk-gaji-ba.component.scss'],
  providers: [ConfirmationService]
})
export class PegawaiSkGajiBAComponent implements OnInit {
  item: PegawaiSkGajiBA = new InisialPegawaiSkGajiBA();;
  selected: PegawaiSkGajiBA;
  listData: PegawaiSkGajiBA[];
  dataDummy: {};
  kodePegawai: PegawaiSkGajiBA[];
  kodeKomponenHarga: PegawaiSkGajiBA[];
  versi: any;
  formAktif: boolean;
  pencarian: string;
  form: FormGroup;
  ...
  clone(cloned: PegawaiSkGajiBA): PegawaiSkGajiBA {
    let hub = new InisialPegawaiSkGajiBA();
    for (let prop in cloned) {
      hub[prop] = cloned[prop];
    }
    let fixHub = new InisialPegawaiSkGajiBA();
    fixHub = {
...
class InisialPegawaiSkGajiBA implements PegawaiSkGajiBA {
