...
import { PegawaiStrukturGajiByLtja} from './pegawai-struktur-gaji-by-ltja.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { AlertService, InfoService, Configuration } from '../../../global';

@Component({
  selector: 'app-pegawai-struktur-gaji-by-ltja',
  templateUrl: './pegawai-struktur-gaji-by-ltja.component.html',
  styleUrls: ['./pegawai-struktur-gaji-by-ltja.component.scss'],
   providers: [ConfirmationService]
})
export class PegawaiStrukturGajiByLtjaComponent implements OnInit {
item: PegawaiStrukturGajiByLtja= new InisialPegawaiStrukturGajiByLtja();;
  selected: PegawaiStrukturGajiByLtja;
  listData: PegawaiStrukturGajiByLtja[];
  dataDummy: {};
  kodePegawai: PegawaiStrukturGajiByLtja[];
  kodeKomponenHarga: PegawaiStrukturGajiByLtja[];
  kodeOperatorRate: PegawaiStrukturGajiByLtja[];
  versi: any;
  formAktif: boolean;
  pencarian: string;
  form: FormGroup;
  ...
  update() {
    this.httpService.update(Configuration.get().dataMasterNew + '/PegawaiStrukturGajiByLtja/update/' + this.versi, this.item).subscribe(response => {
  ...
  clone(cloned: PegawaiStrukturGajiByLtja): PegawaiStrukturGajiByLtja{
    let hub = new InisialPegawaiStrukturGajiByLtja();
    for (let prop in cloned) {
      hub[prop] = cloned[prop];
    }
    let fixHub = new InisialPegawaiStrukturGajiByLtja();
    fixHub = {
...
class InisialPegawaiStrukturGajiByLtja implements PegawaiStrukturGajiByLtja{
