...
import { KomponenGaji, SelectedItem } from './komponen-gaji.interface';
...
@Component({
	selector: 'app-komponen-gaji',
	templateUrl: './komponen-gaji.component.html',
	styleUrls: ['./komponen-gaji.component.scss'],
	providers: [ConfirmationService]
})
export class KomponenGajiComponent implements OnInit {
	selected: any;
	listProduk: any[];
	...
	ngOnInit() {
		...
		this.httpService.get(Configuration.get().dataMasterNew + '/jeniskomponen/findKdJenisKomponenGaji').subscribe(table => {
