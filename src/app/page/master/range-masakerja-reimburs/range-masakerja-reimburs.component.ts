...
// import { RangeMasaKerjaReimbursComponent } from './range-masakerja-reimburs.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-reimburs',
  templateUrl: './range-masakerja-reimburs.component.html',
  styleUrls: ['./range-masakerja-reimburs.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaReimbursComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaReimburs').subscribe(res => {
