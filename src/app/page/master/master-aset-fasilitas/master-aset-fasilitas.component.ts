...
import { MasterAsetFasilitas } from './master-aset-fasilitas.interface';


@Component({
	selector: 'app-master-aset-fasilitas',
	templateUrl: './master-aset-fasilitas.component.html',
	styleUrls: ['./master-aset-fasilitas.component.scss'],
	providers: [ConfirmationService]
})
export class MasterAsetFasilitasComponent implements OnInit {
...
ambilSK(sk) {
  ...
  hapus() {
  	...
  	this.httpService.delete(Configuration.get().dataMasterNew+'/pegawaiskfasilitas/delSKFasilitas/'+deleteItem.noSK+'/'+deleteItem.kdKategoryPegawai+'/'+deleteItem.kdRangeMasaKerja+'/'+deleteItem.kdJabatan).subscribe(response => {
  	},
  	error => {
