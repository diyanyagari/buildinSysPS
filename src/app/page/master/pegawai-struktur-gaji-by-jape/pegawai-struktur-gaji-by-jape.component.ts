...
import { PegawaiStrukturGajiByJape } from './pegawai-struktur-gaji-by-jape.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { AlertService, InfoService, Configuration } from '../../../global';

@Component({
  selector: 'app-pegawai-struktur-gaji-by-jape',
  templateUrl: './pegawai-struktur-gaji-by-jape.component.html',
  styleUrls: ['./pegawai-struktur-gaji-by-jape.component.scss'],
  providers: [ConfirmationService]
})
export class PegawaiStrukturGajiByJapeComponent implements OnInit {
item: PegawaiStrukturGajiByJape= new InisialPegawaiStrukturGajiByJape();;
  selected: PegawaiStrukturGajiByJape;
  listData: PegawaiStrukturGajiByJape[];
  dataDummy: {};
  kodePegawai: PegawaiStrukturGajiByJape[];
  kodeKomponenHarga: PegawaiStrukturGajiByJape[];
  kodeOperatorRate: PegawaiStrukturGajiByJape[];
  versi: any;
  formAktif: boolean;
  pencarian: string;
  form: FormGroup;
  ...
  update() {
    this.httpService.update(Configuration.get().dataMasterNew + '/PegawaiStrukturGajiByJape/update/' + this.versi, this.item).subscribe(response => {
  ...
  clone(cloned: PegawaiStrukturGajiByJape): PegawaiStrukturGajiByJape{
    let hub = new InisialPegawaiStrukturGajiByJape();
    for (let prop in cloned) {
      hub[prop] = cloned[prop];
    }
    let fixHub = new InisialPegawaiStrukturGajiByJape();
    fixHub = {
...
class InisialPegawaiStrukturGajiByJape implements PegawaiStrukturGajiByJape{
