...
// import { RangeMasaKerjaComponent } from './range-masakerja.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja',
  templateUrl: './range-masakerja.component.html',
  styleUrls: ['./range-masakerja.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerja').subscribe(res => {
