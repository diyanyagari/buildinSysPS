...
// import { RangeMasaKerjaPhkComponent } from './range-masakerja-phk.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-phk',
  templateUrl: './range-masakerja-phk.component.html',
  styleUrls: ['./range-masakerja-phk.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaPhkComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaPHK').subscribe(res => {
