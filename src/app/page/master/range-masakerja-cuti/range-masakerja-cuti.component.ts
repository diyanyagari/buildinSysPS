...
// import { RangeMasaKerjaCutiComponent } from './range-masakerja-cuti.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-cuti',
  templateUrl: './range-masakerja-cuti.component.html',
  styleUrls: ['./range-masakerja-cuti.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaCutiComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaCuti').subscribe(res => {
