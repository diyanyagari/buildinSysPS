...
// import { RangeMasaKerjaPensiunComponent } from './range-masakerja-pensiun.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-pensiun',
  templateUrl: './range-masakerja-pensiun.component.html',
  styleUrls: ['./range-masakerja-pensiun.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaPensiunComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaPensiun').subscribe(res => {
