...
// import { RangeMasaKerjaPinjamanComponent } from './range-masakerja-pinjaman.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-pinjaman',
  templateUrl: './range-masakerja-pinjaman.component.html',
  styleUrls: ['./range-masakerja-pinjaman.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaPinjamanComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaPinjaman').subscribe(res => {
