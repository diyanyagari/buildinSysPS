...
import { KomponenPenilaianKompetensi, SelectedItem } from './komponen-penilaiankompetensi.interface';
...
@Component({
	selector: 'app-komponen-penilaiankompetensi',
	templateUrl: './komponen-penilaiankompetensi.component.html',
	styleUrls: ['./komponen-penilaiankompetensi.component.scss'],
	providers: [ConfirmationService]
})
export class KomponenPenilaianKompetensiComponent implements OnInit {
	selected: any;
	listProduk: any[];
	...
	ngOnInit() {
		...
		this.httpService.get(Configuration.get().dataMasterNew + '/jeniskomponen/findKdJenisKomponenPenilaianKompetensi').subscribe(table => {
