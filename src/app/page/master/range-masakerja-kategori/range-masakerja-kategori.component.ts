...
// import { RangeMasaKerjaKategoriComponent } from './range-masakerja-kategori.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-masakerja-kategori',
  templateUrl: './range-masakerja-kategori.component.html',
  styleUrls: ['./range-masakerja-kategori.component.scss'],
  providers: [ConfirmationService]
})
export class RangeMasaKerjaKategoriComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeMasaKerjaKategory').subscribe(res => {
