...
// import { RangeLiburHariOffLiburNasionalComponent } from './range-liburharioff-liburnasional.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-liburharioff-liburnasional',
  templateUrl: './range-liburharioff-liburnasional.component.html',
  styleUrls: ['./range-liburharioff-liburnasional.component.scss'],
  providers: [ConfirmationService]
})
export class RangeLiburHariOffLiburNasionalComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeLemburHariOffLiburNasional').subscribe(res => {
