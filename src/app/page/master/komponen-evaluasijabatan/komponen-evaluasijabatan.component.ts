...
import { KomponenEvaluasiJabatan, SelectedItem } from './komponen-evaluasijabatan.interface';
...
@Component({
	selector: 'app-komponen-evaluasijabatan',
	templateUrl: './komponen-evaluasijabatan.component.html',
	styleUrls: ['./komponen-evaluasijabatan.component.scss'],
	providers: [ConfirmationService]
})
export class KomponenEvaluasiJabatanComponent implements OnInit {
	selected: any;
	listProduk: any[];
	...
	ngOnInit() {
		...
		this.httpService.get(Configuration.get().dataMasterNew + '/jeniskomponen/findKdJenisKomponenEvaluasiJabatan').subscribe(table => {
