...
// import { RangeLiburHariKerjaNormalComponent } from './range-liburharikerjanormal.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { FileService, AlertService, InfoService, Configuration, AuthGuard, ReportService } from '../../../global';
@Component({
  selector: 'app-range-liburharikerjanormal',
  templateUrl: './range-liburharikerjanormal.component.html',
  styleUrls: ['./range-liburharikerjanormal.component.scss'],
  providers: [ConfirmationService]
})
export class RangeLiburHariKerjaNormalComponent implements OnInit {
  selected: any;
  listDataRange: any[];
  ...
  ngOnInit() {
    ...
    this.httpService.get(Configuration.get().dataMasterNew + '/jenisrange/findKdJenisRangeLemburHariKerjaNormal').subscribe(res => {
