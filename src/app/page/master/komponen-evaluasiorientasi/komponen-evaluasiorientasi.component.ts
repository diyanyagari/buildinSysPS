...
import { KomponenEvaluasiOrientasi, SelectedItem } from './komponen-evaluasiorientasi.interface';
...
@Component({
	selector: 'app-komponen-evaluasiorientasi',
	templateUrl: './komponen-evaluasiorientasi.component.html',
	styleUrls: ['./komponen-evaluasiorientasi.component.scss'],
	providers: [ConfirmationService]
})
export class KomponenEvaluasiOrientasiComponent implements OnInit {
	selected: any;
	listProduk: any[];
	...
	ngOnInit() {
		...
		this.httpService.get(Configuration.get().dataMasterNew + '/jeniskomponen/findKdJenisKomponenEvaluasiOrientasi').subscribe(table => {
