...
import { PegawaiStrukturGajiByJa } from './pegawai-struktur-gaji-by-ja.interface';
import { Validators, FormControl, FormGroup, FormBuilder } from '@angular/forms';
import { LazyLoadEvent, ConfirmDialogModule, ConfirmationService } from 'primeng/primeng';
import { AlertService, InfoService, Configuration } from '../../../global';

@Component({
  selector: 'app-pegawai-struktur-gaji-by-ja',
  templateUrl: './pegawai-struktur-gaji-by-ja.component.html',
  styleUrls: ['./pegawai-struktur-gaji-by-ja.component.scss'],
   providers: [ConfirmationService]
})
export class PegawaiStrukturGajiByJaComponent implements OnInit {
item: PegawaiStrukturGajiByJa= new InisialPegawaiStrukturGajiByJa();;
  selected: PegawaiStrukturGajiByJa;
  listData: PegawaiStrukturGajiByJa[];
  dataDummy: {};
  kodePegawai: PegawaiStrukturGajiByJa[];
  kodeKomponenHarga: PegawaiStrukturGajiByJa[];
  kodeOperatorRate: PegawaiStrukturGajiByJa[];
  versi: any;
  formAktif: boolean;
  pencarian: string;
  form: FormGroup;
  ...
  update() {
    this.httpService.update(Configuration.get().dataMasterNew + '/PegawaiStrukturGajiByJa/update/' + this.versi, this.item).subscribe(response => {
  ...
  clone(cloned: PegawaiStrukturGajiByJa): PegawaiStrukturGajiByJa{
    let hub = new InisialPegawaiStrukturGajiByJa();
    for (let prop in cloned) {
      hub[prop] = cloned[prop];
    }
    let fixHub = new InisialPegawaiStrukturGajiByJa();
    fixHub = {
...
class InisialPegawaiStrukturGajiByJa implements PegawaiStrukturGajiByJa{
