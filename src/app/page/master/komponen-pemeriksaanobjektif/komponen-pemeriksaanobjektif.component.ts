...
import { KomponenPemeriksaanObjektif, SelectedItem } from './komponen-pemeriksaanobjektif.interface';
...
@Component({
	selector: 'app-komponen-pemeriksaanobjektif',
	templateUrl: './komponen-pemeriksaanobjektif.component.html',
	styleUrls: ['./komponen-pemeriksaanobjektif.component.scss'],
	providers: [ConfirmationService]
})
export class KomponenPemeriksaanObjektifComponent implements OnInit {
	selected: any;
	listProduk: any[];
	...
	ngOnInit() {
		...
		this.httpService.get(Configuration.get().dataMasterNew + '/jeniskomponen/findKdJenisKomponenPemeriksaanObjektif').subscribe(table => {
