...
import {AlertService} from '../../app/global';
...
export class GridsterComponent implements OnInit, OnChanges, OnDestroy, GridsterComponentInterface {
  ...
  constructor(el: ElementRef, public renderer: Renderer2, public cdRef: ChangeDetectorRef, private alertService: AlertService) {
    ...
    if (itemComponent.$item.x === -1 || itemComponent.$item.y === -1) {
      ...
      if (!this.$options.disableWarnings) {
        console.warn('Can\'t be placed in the bounds of the dashboard, trying to auto position!/n' +
          ...
          this.alertService.info('Auto-Position', 'Area Tidak Muat/Cukup Sehingga Dilakukan Auto-Position');
      }
